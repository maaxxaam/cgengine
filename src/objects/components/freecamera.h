...
private:
    ...
    // Event references
    eastl::string _moveUpStr, _moveDownStr, _moveLeftStr, _moveRightStr, _moveBackStr, _moveForwardsStr, _rotateMouseStr, _rotateLeftStr, _rotateRightStr, _rotateUpStr, _rotateDownStr;
