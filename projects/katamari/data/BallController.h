...
class BallController: public Events::EventListener, public Update {
public:
    void init(DynamicCharacterController* controller, Events::Key left, Events::Key right, Events::Key up, Events::Key down, eastl::string prefix);
...
private:
    ...
    eastl::string _strUp, _strDown, _strLeft, _strRight;
